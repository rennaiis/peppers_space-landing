...
const SequentialAnimation = React.forwardRef(function SequentialAnimation(
  {imagesData, width, height, fps = 60, onEndAnimation, loop = false, total, onUpdate},
  ref,
) {
  ...
  useEffect(() => {
    ...
    function update() {
      ...
      ctx.drawImage(
        currentImage,
        canvas.width / 2 - currentImage.width / 2,
