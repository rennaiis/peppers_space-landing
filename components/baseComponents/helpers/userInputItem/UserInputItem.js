...
const UserInputItem = React.forwardRef(function UserInputItem({children, ignoreItem = false, ...rest}, ref) {
  ...
  if (children.length > 0) throw new Error("UserInputComponent: child must be single");
